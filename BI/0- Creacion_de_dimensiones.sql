...
create table nibble.Hechos_Items_Ventas (
    ...
    constraint PK_Hechos_Items_Ventas primary key (id_provincia, id_tiempo, id_canal, cod_producto, id_medio_de_envio, id_rango_etario, id_medio_de_pago_venta)
); 
...
create table nibble.Hechos_Ventas (
    ...
    constraint PK_Hechos_Ventas primary key (id_tiempo, id_canal, id_medio_de_envio, id_medio_de_pago_venta, id_tipo_descuento)
); 
